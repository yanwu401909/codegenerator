package com.up72.framework.generator.util.typemapping;
...
public class DatabaseDataTypesUtils {
	...
	public static boolean isDate(String column) {
		if(column.endsWith("Date") || column.endsWith("Timestamp") || column.endsWith("Time")) {
			return true;
		}
		return false;
	}
