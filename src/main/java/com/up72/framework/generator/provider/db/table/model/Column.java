package com.up72.framework.generator.provider.db.table.model;



import java.util.List;

import com.up72.framework.generator.GeneratorProperties;
import com.up72.framework.generator.provider.db.table.model.ForeignKey.ReferenceKey;
import com.up72.framework.generator.provider.db.table.model.util.ColumnHelper;
import com.up72.framework.generator.util.GLogger;
import com.up72.framework.generator.util.StringHelper;
import com.up72.framework.generator.util.TestDataGenerator;
import com.up72.framework.generator.util.typemapping.ActionScriptDataTypesUtils;
import com.up72.framework.generator.util.typemapping.DatabaseDataTypesUtils;
import com.up72.framework.generator.util.typemapping.JavaPrimitiveTypeMapping;
...
public class Column {
	...
	public boolean getIsDateTimeColumn() {
		return DatabaseDataTypesUtils.isDate(getColumnName());
	}
